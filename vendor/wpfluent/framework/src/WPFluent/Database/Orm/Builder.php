...
class Builder
{
     ...
     *
     * @var \FluentGemini\Framework\Database\Query\Builder
     */
    protected $query;
     ...
     * @param  \FluentGemini\Framework\Database\Orm\Scope|\Closure  $scope
     * @return $this
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentGemini\Framework\Database\Orm\Model|\FluentGemini\Framework\Database\Orm\Collection|static[]|static|null
     */
     ...
     *
     * @param  array  $columns
     * @return \FluentGemini\Framework\Database\Orm\Model|static|null
     */
     ...
     *
     * @param  string  $name
     * @return \FluentGemini\Framework\Database\Orm\Relations\Relation
     */
     ...
     *
     * @param  \FluentGemini\Framework\Database\Orm\Builder  $hasQuery
     * @param  \FluentGemini\Framework\Database\Orm\Relations\Relation  $relation
     * @param  string  $operator
     * @param  int  $count
     * @param  string  $boolean
     * @return \FluentGemini\Framework\Database\Orm\Builder|static
     ...
     *
     * @param  \FluentGemini\Framework\Database\Orm\Builder  $relation
     * @return \FluentGemini\Framework\Database\Orm\Builder|static
     */
