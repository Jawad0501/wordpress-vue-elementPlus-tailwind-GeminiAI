...
use FluentGemini\Framework\Support\Str;
use FluentGemini\Framework\Foundation\App;
use FluentGemini\Framework\Support\UrlRoutable;
use FluentGemini\Framework\Database\Orm\DateTime;
use FluentGemini\Framework\Foundation\Dispatcher;
use FluentGemini\Framework\Support\QueueableEntity;
use FluentGemini\Framework\Support\JsonableInterface;
use FluentGemini\Framework\Support\ArrayableInterface;
use FluentGemini\Framework\Database\Orm\Relations\Pivot;
use FluentGemini\Framework\Database\Orm\Relations\HasOne;
use FluentGemini\Framework\Database\Orm\ModelHelperTrait;
use FluentGemini\Framework\Database\Orm\Relations\MorphTo;
use FluentGemini\Framework\Database\Orm\Relations\HasMany;
use FluentGemini\Framework\Database\Orm\Relations\MorphOne;
use FluentGemini\Framework\Database\Orm\Relations\MorphMany;
use FluentGemini\Framework\Database\Orm\Relations\Relation;
use FluentGemini\Framework\Database\Orm\Relations\BelongsTo;
use FluentGemini\Framework\Database\Orm\Relations\MorphToMany;
use FluentGemini\Framework\Support\Collection as BaseCollection;
use FluentGemini\Framework\Database\Orm\Relations\BelongsToMany;
use FluentGemini\Framework\Database\Orm\Relations\HasManyThrough;
use FluentGemini\Framework\Database\Query\Builder as QueryBuilder;
use FluentGemini\Framework\Database\ConnectionResolverInterface as Resolver;
...
abstract class Model implements ArrayAccess, ArrayableInterface, JsonableInterface, JsonSerializable, QueueableEntity, UrlRoutable
{
	 ...
	 *
	 * @var \FluentGemini\Framework\Database\ConnectionResolverInterface
	 */
	 ...
	 *
	 * @var \FluentGemini\Framework\Foundation\Dispatcher
	 */
     ...
     *
     * @param  \FluentGemini\Framework\Database\Orm\Scope|\Closure|string  $scope
     ...
     *
     * @param  \FluentGemini\Framework\Database\ORM\Scope|string  $scope
     * @return bool
     */
     ...
     *
     * @param  \FluentGemini\Framework\Database\Orm\Scope|string  $scope
     * @return \FluentGemini\Framework\Database\Orm\Scope|\Closure|null
     */
     ...
     * @return $this
     *
     * @throws \FluentGemini\Framework\Database\Orm\MassAssignmentException
     */
     ...
     * @return \FluentGemini\Framework\Database\Orm\Collection|static[]
     */
     ...
     *
     * @param  array|string  $relations
     * @return \FluentGemini\Framework\Database\Orm\Builder|static
     */
     ...
     * @return \FluentGemini\Framework\Database\Orm\Relations\HasOne
     */
     ...
     * @param  string  $id
     * @param  string  $localKey
     * @return \FluentGemini\Framework\Database\Orm\Relations\MorphOne
     */
     ...
     * @return \FluentGemini\Framework\Database\Orm\Relations\BelongsTo
     */
     ...
     * @param  string  $type
     * @param  string  $id
     * @return \FluentGemini\Framework\Database\Orm\Relations\MorphTo
     */
     ...
     * @param  string  $foreignKey
     * @param  string  $localKey
     * @return \FluentGemini\Framework\Database\Orm\Relations\HasMany
     */
     ...
     * @return \FluentGemini\Framework\Database\Orm\Relations\HasManyThrough
     */
     ...
     * @param  string  $id
     * @param  string  $localKey
     * @return \FluentGemini\Framework\Database\Orm\Relations\MorphMany
     */
     ...
     * @param  string  $otherKey
     * @param  string  $relation
     * @return \FluentGemini\Framework\Database\Orm\Relations\BelongsToMany
     */
     ...
     * @param  string  $otherKey
     * @param  bool  $inverse
     * @return \FluentGemini\Framework\Database\Orm\Relations\MorphToMany
     */
     ...
     *
     * @return \FluentGemini\Framework\Database\Orm\DateTime
     */
    ...
    protected function getRelationshipFromMethod($method)
    {
        ...
        if (! $relations instanceof Relation) {
            throw new LogicException('Relationship method must return an object of type '
                .'FluentGemini\Framework\Database\Orm\Relations\Relation');
        }
     ...
     *
     * @return \FluentGemini\Framework\Database\Connection
     */
     ...
     *
     * @return \FluentGemini\Framework\Database\ConnectionResolverInterface
     */
     ...
     *
     * @param  \FluentGemini\Framework\Database\ConnectionResolverInterface  $resolver
     * @return void
     */
     ...
     *
     * @return \FluentGemini\Framework\Contracts\Events\Dispatcher
     */
     ...
     *
     * @param  \FluentGemini\Framework\Foundation\Dispatcher  $dispatcher
     * @return void
     */
