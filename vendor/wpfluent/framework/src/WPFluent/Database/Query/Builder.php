...
use FluentGemini\Framework\Pagination\LengthAwarePaginator;
use FluentGemini\Framework\Support\MacroableTrait;
use FluentGemini\Framework\Database\Query\Grammar;
use FluentGemini\Framework\Database\Query\Processor;
use FluentGemini\Framework\Support\ArrayableInterface;
use FluentGemini\Framework\Database\ConnectionInterface;
...
class Builder
{
     ...
     *
     * @var \FluentGemini\Framework\Database\Query\WPDBConnection
     */
     ...
     *
     * @var \FluentGemini\Framework\Database\Query\Grammar
     */
    protected $grammar;
     ...
     *
     * @var \FluentGemini\Framework\Database\Query\Processor
     */
    protected $processor;
     ...
     *
     * @param \FluentGemini\Framework\Database\ConnectionInterface $connection
     * @param \FluentGemini\Framework\Database\Query\Grammar $grammar
     * @param \FluentGemini\Framework\Database\Query\Processor $processor
     * @return void
     */
     ...
     * @return \FluentGemini\Framework\Database\Query\Builder|static
     */
     ...
     *
     * @param \Closure|\FluentGemini\Framework\Database\Query\Builder|string $query
     * @param string $as
     * @return \FluentGemini\Framework\Database\Query\Builder|static
     *
     ...
     *
     * @param \FluentGemini\Framework\Database\Query\Builder|static $query
     * @param string $boolean
     * @return $this
     */
     ...
     *
     * @param \FluentGemini\Framework\Database\Query\Builder|\Closure $query
     * @param bool $all
     * @return \FluentGemini\Framework\Database\Query\Builder|static
     */
     ...
     * @param int|null $page
     * @return \FluentGemini\Framework\Pagination\LengthAwarePaginatorInterface
     */
     ...
     * @param string $pageName
     * @param int|null $page
     * @return \FluentGemini\Framework\Pagination\PaginatorInterface
     */
     ...
     *
     * @param mixed $value
     * @return \FluentGemini\Framework\Database\Query\Expression
     */
     ...
     *
     * @return \FluentGemini\Framework\Database\Query\Processor
     */
     ...
     *
     * @return \FluentGemini\Framework\Database\Query\Grammar
     */
